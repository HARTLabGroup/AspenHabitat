...
if(!file.exists(here("Results", "bivariate-RF-AUC.csv"))){
  ...
  dat[,c(sort(climate.varz))] %>% cor() %>% round(digits=2) %>% ggcorrplot(lab=TRUE,type="lower",lab_size=2) %>% ggsave(filename=here("Results", "Figures", "FigureS1.jpg"), width=210, heigh=210, units="mm")
...
```{r FigS1, fig.id="FigS1", fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="Correlation coefficients between pairs of climate predictor variables examined for inclusion in SDM", fig.width=5, fig.height=5}
knitr::include_graphics(here("Results/Figures/FigureS1.jpg"), dpi = NA)
```

\newpage

```{r FigS2, fig.id="FigS2", fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="The distributions of predictor variables in areas with and without aspen.", fig.width=7, fig.height=5}
knitr::include_graphics(here("Results", "Figures", "FigureS2.jpg"), dpi = NA)
```

## Appendix S3: Additional figures

```{r Datadistribution, fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="The spatial distribution of training and testing data used to build the SDMs.", fig.width=7, fig.height=5}
if(!file.exists(here("Results", "Figures", "FigureS3.jpg"))){
...
Fig.file <- here("Results", "Figures", "FigDatDist.jpg")
  jpeg(Fig.file, width=7, height=5, units="in", res=300)
  tm.sampling
whatever <- dev.off()
}
knitr::include_graphics(here("Results", "Figures", "FigDatDistjpg"), dpi = NA)
```

```{r MissClassMap, fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="Spatial patterns of missclassification for the ensemble model.", fig.width=5, fig.height=3.5}
knitr::include_graphics(here("Results", "Figures", "FigureS4.jpg"), dpi = NA)
```

```{r LossGainTS, fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="Barplots illustrating the temporal patterns in the areas were aspen my lost, gained, or remain stable based on the current distribution of aspen and the ensemeble SDM forecast of future aspen habitat suitability.", fig.width=4.5, fig.height=4.5}
knitr::include_graphics(here("Results", "Figures", "FigureS5.jpg"), dpi = NA)
```

```{r LossGainBox, fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="Boxplots illustrating spatial patterns in the areas were aspen my lost, gained, or remain stable based on the current distribution of aspen the ensemeble SDM forecast of future aspen habitat suitability under the SSP2-45 scenario.", fig.width=4.5, fig.height=5}
knitr::include_graphics(here("Results", "Figures", "FigureS6.jpg"), dpi = NA)
```

```{r GainDistanceMaps, fig.cap.pre="Figure S", fig.lp="supp-fig", fig.cap="Distance to the nearest existing aspen patch for pixels were future climate may promote aspen expansion by 2100 under the SSP2-4.5 scenario.",fig.width=7}
knitr::include_graphics(here("Results", "Figures", "FigureS7.jpg"), dpi = NA)
```
