...
```{r FigS1, fig.cap="Correlation coefficients between pairs of climate predictor variables examined for inclusion in SDM", out.width = "180mm", out.height="180mm"}
...
knitr::include_graphics(here("Results", "Figures", "FigureS3.jpg"), dpi = NA)
```
