...
clim <- rast(here("Data/Spatial/Climate/CLimateNA/ensemble_8GCMs_ssp370_2011_2040/ensemble_8GCMs_ssp370_2011_2040_bioclim/ensemble_8GCMs_ssp370_2011_2040_AHM.tif")) 
SRM <- st_read(here("Data/Spatial/Ecoregions/us_eco_l3.shp")) %>% filter(US_L3NAME == 'Southern Rockies') %>% st_transform(crs=crs(clim))
clim <- clim %>% crop(SRM)
...
elev_coarse <- terra::project(elev,clim, method="bilinear")
```
...
writeRaster(ds_layer, here("Data/Spatial/Downscaled/ensemble_8GCMs_ssp370_2011_2040_AHM-downscaled.tif"))
```
