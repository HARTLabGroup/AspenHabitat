...
SRM <- st_read(here("Data/Spatial/Ecoregions/us_eco_l3.shp")) %>% 
  ...
  st_transform(crs(elev)) %>% st_buffer(20000)
...
select.climate.variables <-c("CMI", "CMD","MAP", "MAT", "MSP", "SHM", "MWMT", "MCMT", "PPT_sp", "PPT_at", "TD", "bFF", "RH", "DD_0", "DD5")
...
for(j in select.climate.variables){
  ...
  writeRaster(ds_layer, paste0(here("Data/Spatial/Downscaled/Normal_1981_2010_"), j, "-downscaled.tif"))
  rm(ds_layer) # remove 
